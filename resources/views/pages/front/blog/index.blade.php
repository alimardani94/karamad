...
@section('header')
    @include('pages.header.header1', ['headerBG' => asset('assets/img/header/books.jpg'), 'headerTitle' => 'مقالات'])
@stop
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        ...
                        <p class="mt-4 mb-5">
                            با کارامد هر آنچه که برای آموزش خود نیاز دارید، با بهترین کیفیت دریافت کنید وبا شرکت در کلاس
